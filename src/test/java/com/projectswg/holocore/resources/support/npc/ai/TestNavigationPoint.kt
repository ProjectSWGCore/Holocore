...
class TestNavigationPoint : TestRunnerNoIntents() {
	@Test
	fun testDistanceTo() {
		val src = NavigationPoint.at(null, Location.builder().setPosition(0.0, 0.0, 0.0).build(), 0)
		val dst = NavigationPoint.at(null, Location.builder().setPosition(0.0, 0.0, 10.0).build(), 0)

		Assertions.assertEquals(10.0, src.distanceTo(dst), 1E-7)
		Assertions.assertEquals(10.0, dst.distanceTo(src), 1E-7)
		Assertions.assertEquals(5.0, src.distanceTo(null, Location.builder().setPosition(5.0, 0.0, 0.0).build()), 1E-7)
	}

	@Test
	fun testDirect() {
		val start = location(0.0, 0.0, 0.0)
		val end = location(10.0, 0.0, 0.0)
