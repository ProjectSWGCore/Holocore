...
public class DraftSchematics extends ObjectController {
	...
	public DraftSchematics(long toolId, long craftingStationId, int schematicsCounter, int[] schematicsId, int[] schematicsCrc, byte[][] schematicSubcategories) {
		super();
		this.toolId = toolId;
	...
	public DraftSchematics(NetBuffer data) {
		super(CRC);
		decode(data);
	}
