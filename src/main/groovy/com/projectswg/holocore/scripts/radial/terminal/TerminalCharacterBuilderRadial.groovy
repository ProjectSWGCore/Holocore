...
class TerminalCharacterBuilderRadial implements RadialHandlerInterface {
	...
	static def handleCategorySelection(Player player, Map<String, String> parameters) {
	...
	static def handleArmorSelection(Player player, Map<String, String> parameters) {
	...
	static def handleWeaponSelection(Player player, Map<String, String> parameters) {
		def selection = SuiListBox.getSelectedRow(parameters)
	...
	static def handleWearablesSelection(Player player, Map<String, String> parameters) {
		def selection = SuiListBox.getSelectedRow(parameters)
	...
	static def handleToolsSelection(Player player, Map<String, String> parameters) {
		def selection = SuiListBox.getSelectedRow(parameters)
	...
	static
	def handleTravelSelection(Player player, Map<String, String> parameters) {
		def selection = SuiListBox.getSelectedRow(parameters)
