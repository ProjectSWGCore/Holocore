...
public class CloseContainerIntent extends Intent {
	
	private final CreatureObject creature;
	private final SWGObject container;
	private final String slot;
	
	public CloseContainerIntent(@NotNull CreatureObject creature, @NotNull SWGObject container, @NotNull String slot) {
	...
	public static void broadcast(@NotNull CreatureObject creature, @NotNull SWGObject container, @NotNull String slot) {
		new CloseContainerIntent(creature, container, slot).broadcast();
	}
}
