...
public class CompleteQuestRequirement implements Requirement {
	
	private final String questName;
	
	public CompleteQuestRequirement(String questName) {
	...
	public boolean test(Player player) {
		...
		return playerObject.isQuestComplete(questName);
	}
}
