...
class CmdGroupChat : ICmdCallback {
	override fun execute(player: Player, target: SWGObject?, args: String) {
		...
		val group = checkNotNull(ObjectLookup.getObjectById(groupId) as GroupObject?) { "groupId is set but no GroupObject exists" }
		ChatRoomMessageIntent(player, group.chatRoomPath, args).broadcast()
	}
}
