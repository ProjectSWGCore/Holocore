...
import com.projectswg.holocore.resources.gameplay.conversation.events.AdvanceQuestEvent;
import com.projectswg.holocore.resources.support.data.server_info.loader.conversation.EventParser;

import java.util.Map;

public class AdvanceQuestEventParser implements EventParser<AdvanceQuestEvent> {
	
	@Override
	public AdvanceQuestEvent parse(Map<String, Object> args) {
		String questName = (String) args.get("quest");
		
		return new AdvanceQuestEvent(questName);
	}
}
