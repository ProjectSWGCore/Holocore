...
class ChangePlayerFactionEventParser : EventParser<ChangePlayerFactionEvent> {
	override fun parse(args: Map<String, Any>): ChangePlayerFactionEvent {
		val factionName = args["faction"] as String?

		return ChangePlayerFactionEvent(factionName!!)
	}
}
