...
import com.projectswg.holocore.resources.gameplay.conversation.events.GrantQuestEvent;
...
public class GrantQuestEventParser implements EventParser<GrantQuestEvent> {
	
	@Override
	public GrantQuestEvent parse(Map<String, Object> args) {
		String questName = (String) args.get("quest");
		
		return new GrantQuestEvent(questName);
	}
}
