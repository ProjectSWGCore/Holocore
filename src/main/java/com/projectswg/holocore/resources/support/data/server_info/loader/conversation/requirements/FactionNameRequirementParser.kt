...
class FactionNameRequirementParser : RequirementParser<FactionNameRequirement> {
	override fun parse(args: Map<String, Any>): FactionNameRequirement {
		val factionName = args["faction"] as String?

		return FactionNameRequirement(factionName!!)
	}
}
