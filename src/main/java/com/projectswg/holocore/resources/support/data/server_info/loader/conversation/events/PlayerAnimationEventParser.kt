...
class PlayerAnimationEventParser : EventParser<PlayerAnimationEvent> {
	override fun parse(args: Map<String, Any>): PlayerAnimationEvent {
		val animation = args["animation"] as String?

		return PlayerAnimationEvent(animation!!)
	}
}
