...
class CmdSetBiography : ICmdCallback {
	override fun execute(player: Player, target: SWGObject?, args: String) {
		...
		creatureObject.playerObject.biography = args

		player.sendPacket(BiographyUpdate(creatureObject.objectId, creatureObject.objectId, args))
	}
}
