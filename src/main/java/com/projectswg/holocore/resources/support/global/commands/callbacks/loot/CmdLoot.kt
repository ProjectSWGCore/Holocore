...
class CmdLoot : ICmdCallback {
	override fun execute(player: Player, target: SWGObject?, args: String) {
		val creature = player.creatureObject
		if (target !is CreatureObject || creature == null) return

		LootRequestIntent(player, (target as CreatureObject?)!!, LootType.LOOT_ALL).broadcast()
	}
}
