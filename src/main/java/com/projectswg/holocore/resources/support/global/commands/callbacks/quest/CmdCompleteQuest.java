...
public class CmdCompleteQuest implements ICmdCallback {
	
	@Override
	public void execute(@NotNull Player player, @Nullable SWGObject target, @NotNull String args) {
		String[] split = args.split(" ");
		CRC crc = new CRC(Integer.parseInt(split[0]));
		String questName = crc.getString();
		
		new CompleteQuestIntent(player, questName).broadcast();
	}
}
