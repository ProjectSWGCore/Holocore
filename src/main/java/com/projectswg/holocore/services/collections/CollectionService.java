...
public class CollectionService extends Service {
	...
	public CollectionService() {
		...
		if (clickyDatabase == null)
			throw new ProjectSWG.CoreException("Database collection_clicky failed to load");
		if (consumeDatabase == null)
			throw new ProjectSWG.CoreException("Database collection failed to load");
	...
	private void handleRadialRequestIntent(RadialRequestIntent rri){
		...
		if (isClickyCollectionItem(iff) || isConsumeCollectionItem(itemName, iff)) {
			...
			WorldItemRadial.getOptions(options, rri.getPlayer(), rri.getTarget());
