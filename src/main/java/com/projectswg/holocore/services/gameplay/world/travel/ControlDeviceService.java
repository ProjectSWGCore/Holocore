 ...
 */
public class ControlDeviceService extends Service {	// TODO rename to ControlDeviceService
	...
	public ControlDeviceService() {
		this.calledPets = new ConcurrentHashMap<>();
	}
	...
	private void storePet(CreatureObject pet, SWGObject petControlDevice) {
		...
		Log.d("Stored pet %s in control device %s", pet, petControlDevice);
	}
