...
@ManagerStructure(children = [CharacterCreationService::class, SuiService::class, CharacterLookupService::class, ConnectionService::class, LoginService::class, PlayerSessionService::class, ZoneService::class])
