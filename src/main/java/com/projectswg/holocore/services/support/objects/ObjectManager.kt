...
@ManagerStructure(children = [AwarenessService::class, ClientAwarenessService::class, StaticService::class, ItemManager::class, RadialService::class, ObjectStorageService::class])
