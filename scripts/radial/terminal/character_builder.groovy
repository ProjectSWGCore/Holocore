...
static def handleWeaponSelection(Player player, CreatureObject creature, SuiEvent eventType, Map<String, String> parameters) {
	if (eventType != SuiEvent.OK_PRESSED) {
		return
	}
...
static def handleTravelSelection(Player player, CreatureObject creature, SuiEvent eventType, Map<String, String> parameters) {
